...
namespace ZBYGate_Data_Collection.Plate
{
    ...
    public partial class NativeMethods
    {
        ...
        /***************************************************************/
        /* int _stdcall CLIENT_LPRC_AlterDeviceInfo(ceInfo(原型                                             
        /*char *pCameraIP,                                             CLIENT_LPRC_DeviceInfo  
        /*pBuf)功能 修改指定的设备的设备信息pCameraIP[in]  
        /*需要修改的相机设备的ip地址参数pBuf[in]             
        /*存储需要修改的设备信息结构体成功,返回0返回值否则,返回非0
        /*此函数一般配合 CLIENT_LPRC_SearchDeviceList 搜索设备使用。说明
        /**************************************************************/
        [System.Runtime.InteropServices.DllImportAttribute("WTY.dll", EntryPoint = "CLIENT_LPRC_AlterDeviceInfo", CallingConvention = System.Runtime.InteropServices.CallingConvention.StdCall)]
        public static extern int CLIENT_LPRC_AlterDeviceInfo(System.IntPtr pCameraIP, CLIENT_LPRC_DeviceInfo pBuf);
    }
}
